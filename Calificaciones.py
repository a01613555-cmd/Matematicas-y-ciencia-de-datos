...
def user_input_features():
  # Entrada
  Estudio = st.number_input('Estudio:', min_value=0, max_value=100, value = 0, step = 1)
  Sueño = st.number_input('Sueño:',  min_value=0, max_value=100, value = 0, step = 1)
  Asistencia = st.number_input('Asistencia:', min_value=0, max_value=100, value = 0, step = 1)
  Previa = st.number_input('Calificación previa:', min_value=0, max_value=100, value = 0, step = 1)
